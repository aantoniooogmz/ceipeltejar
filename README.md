...
├── matricula.html              → Proceso de matrícula y admisión curso 2026/27
│
...
├── menu-comedor.html           → Menú semanal del comedor (actualizable)
...
│
├── galeria.html                → Galería de fotos por categorías con lightbox
├── calendario.html             → Calendario escolar 2025/26 con eventos
...
| Matrícula | `matricula.html` | [Ver](https://aantoniooogmz.github.io/ceipeltejar/matricula.html) | [Ver](https://blogsaverroes.juntadeandalucia.es/ceipeltejar/matricula/) |
...
| Menú del comedor | `menu-comedor.html` | [Ver](https://aantoniooogmz.github.io/ceipeltejar/menu-comedor.html) | [Ver](https://blogsaverroes.juntadeandalucia.es/ceipeltejar/menu-comedor/) |
...
| Galería de fotos | `galeria.html` | [Ver](https://aantoniooogmz.github.io/ceipeltejar/galeria.html) | [Ver](https://blogsaverroes.juntadeandalucia.es/ceipeltejar/galeria/) |
| Calendario escolar | `calendario.html` | [Ver](https://aantoniooogmz.github.io/ceipeltejar/calendario.html) | [Ver](https://blogsaverroes.juntadeandalucia.es/ceipeltejar/calendario-escolar/) |
| Error 404 | `404.html` | [Ver](https://aantoniooogmz.github.io/ceipeltejar/404.html) | — |
...
## 🔄 Páginas que requieren actualización periódica

| Página | Qué actualizar | Frecuencia |
|--------|---------------|------------|
| `menu-comedor.html` | Añadir nueva semana al array `SEMANAS` | Cada semana |
| `galeria.html` | Añadir URLs de fotos al array `FOTOS` | Cuando haya fotos nuevas |
| `calendario.html` | Añadir eventos al array `EVENTOS` | Cuando haya fechas nuevas |
| `matricula.html` | Actualizar fechas del plazo de admisión | Cada curso |
| `planes-y-proyectos.html` | Añadir nuevos PDFs de Drive | Cuando haya documentos nuevos |
...
- **Las fotos** de la galería deben estar en Google Drive con el formato: `https://drive.google.com/uc?export=view&id=ID_DEL_ARCHIVO`
